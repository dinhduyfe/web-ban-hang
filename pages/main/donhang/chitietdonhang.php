...
<div>
    ...
    ?>
        <tr style="height: 140px;">
            ...
            <td align="center"><img style="width: 140px; height: 140px;" src="admincp/modules/quanlysp/uploads/<?php echo $row_sanpham["hinhanh"] ?>" alt=""></td>
    ...
    <div style="display:flex; justify-content:end; margin:8px 5%" class="reload">
        <a href="?quanly=donhang">Quay lại</a>
    </div>
</div>
